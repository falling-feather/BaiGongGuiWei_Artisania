...
export const REGION_CHAPTERS: RegionChapterSpec[] = [
  ...
  },
  {
    ...
    gaps: ['已有活动即时订单，但仍缺家访、协作配方和完整节庆摊位链。', 'qiandian-dongchuan-copper 仍缺人工 JSON。'],
  },
  {
  ...
  },
  {
    ...
    nextActions: ['补徽商会馆荐藏回访订单链', '补墨砚深巷或歙石山坑人工地图', '补商会信用风险分支'],
    gaps: ['商会已有活动即时订单，但仍缺长线信用风险和荐藏回访分支。', 'huizhou-ink-alley 与 huizhou-she-stone 仍缺人工 JSON。'],
  },
  {
  ...
  },
  {
    ...
    nextActions: ['补雪山驿口或颜料矿谷人工地图', '补高原供展订单长线回访'],
    gaps: ['已有活动即时订单和唐卡失败分支，但缺完整地区章节长线收束。', 'xueyu-snow-pass、xueyu-pigment-valley 与 xueyu-silver-tent 仍缺人工 JSON。'],
  },
  {
