...
export const REGION_CHAPTERS: RegionChapterSpec[] = [
  ...
  },
  {
    ...
    homeVisitIds: ['homevisit-pingyao-polish-room', 'homevisit-pingyao-client-return', 'homevisit-lei-credit-ledger-aftertalk'],
    collabRecipeIds: ['collab-pingyao-hand-polish'],
    escortEncounterIds: ['escort-jingji-canal-tribute'],
    smokeScenarioIds: ['chapter-sanjin-piaohao-lacquer'],
    nextActions: ['补煤铁窑塬或清徐醋坊人工地图', '扩展多轮本金/利钱统计到 M3 长线经济'],
    gaps: ['已有票号活动即时订单、雷掌柜信用单违约、推光样柜回访、票号漆档续单回本修复、复违约利钱挂账和票号账本后日谈；仍缺 M3 级多轮本金/利钱统计。', 'sanjin-coal-yard 与 sanjin-vinegar-yard 仍缺人工 JSON。'],
  },
  {
