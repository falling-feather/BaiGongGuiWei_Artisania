...
export const REGION_CHAPTERS: RegionChapterSpec[] = [
  {
    ...
    homeVisitIds: ['homevisit-ning-masterwork-critique', 'homevisit-qiao-lantern-gallery', 'homevisit-xiaoman-yard-display'],
    collabRecipeIds: ['collab-yunjin-pick-weft'],
    escortEncounterIds: ['escort-jingji-canal-tribute'],
    smokeScenarioIds: ['jiangnan'],
  ...
  },
  {
    ...
    orderHooks: [
      { source: 'activity', id: 'qd-tea-horse-road', note: '现有路线活动先作为章节订单前置。' },
      { source: 'escort', id: 'escort-tea-horse-load-ledger', note: '茶马负重簿与黔滇路线相连。' },
      { source: 'proposed', id: 'proposed-qiandian-silver-festival-order', note: '待补苗银礼俗节事后续单。', readsItemState: true },
    ],
    homeVisitIds: [],
    collabRecipeIds: [],
    escortEncounterIds: ['escort-tea-horse-load-ledger'],
    smokeScenarioIds: ['qiandian'],
    nextActions: ['补苗银礼俗家访', '补黔滇协作配方', '补银染节事三阶段活动与追单'],
    gaps: ['缺家访、协作配方和完整节庆摊位链，是 M1 第一优先骨架区。', 'qiandian-dongchuan-copper 仍缺人工 JSON。'],
  },
  {
    ...
    smokeScenarioIds: ['jingchu'],
    nextActions: ['补渡口水运订单链', '补楚漆修复后续追单', '补湘绣楼人物回访'],
    gaps: ['已有组件但缺完整章节活动和订单回流闭环。', 'jingchu-mine-yard 与 jingchu-xiang-embroidery 仍缺人工 JSON。'],
  },
  {
  ...
  },
  {
    ...
    orderHooks: [
      ...
      { source: 'activity', id: 'hz-merchant-hall', note: '徽商会馆作为商会信用前置。' },
    ],
    homeVisitIds: ['homevisit-wang-paper-inscription', 'homevisit-wang-collector-return'],
    collabRecipeIds: ['collab-wang-paper-mount'],
    escortEncounterIds: ['escort-ganpo-kiln-firewood'],
    smokeScenarioIds: ['huizhou'],
    nextActions: ['补纸墨合单', '补徽商会馆荐藏订单链', '补墨砚深巷或歙石山坑人工地图'],
    gaps: ['商会仍是活动入口，尚未形成完整章节订单链。', 'huizhou-ink-alley 与 huizhou-she-stone 仍缺人工 JSON。'],
  },
  {
    ...
    escortEncounterIds: ['escort-jingji-canal-tribute'],
    smokeScenarioIds: ['jingji'],
    nextActions: ['补采办许可读取地区声望和商誉', '补都门市口人工地图与订单入口'],
    gaps: ['宫造采办章节还未形成明确推进线。', 'jingji-market-gate 仍缺人工 JSON。'],
  },
  {
    ...
    orderHooks: [
      ...
      { source: 'activity', id: 'sj-piaohao', note: '票号信用活动作为商誉前置。' },
    ],
    homeVisitIds: ['homevisit-pingyao-polish-room', 'homevisit-pingyao-client-return'],
    collabRecipeIds: ['collab-pingyao-hand-polish'],
    escortEncounterIds: ['escort-jingji-canal-tribute'],
    smokeScenarioIds: ['sanjin'],
    nextActions: ['补票号信用单的长期违约/回本指标', '补煤铁窑塬或清徐醋坊人工地图'],
    gaps: ['活动和订单仍偏样张，需要章节化信用风险。', 'sanjin-coal-yard 与 sanjin-vinegar-yard 仍缺人工 JSON。'],
  },
  {
    ...
    smokeScenarioIds: ['xueyu', 'n3-thangka-reject'],
    nextActions: ['补雪山驿口或颜料矿谷人工地图', '补材料状态影响订单验收的章节流'],
    gaps: ['已有唐卡失败分支，但缺完整地区章节和订单链。', 'xueyu-snow-pass、xueyu-pigment-valley 与 xueyu-silver-tent 仍缺人工 JSON。'],
  },
  {
    ...
    smokeScenarioIds: ['xiyu', 'xiyu-caravan'],
