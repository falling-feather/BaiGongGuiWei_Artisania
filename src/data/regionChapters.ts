...
export const REGION_CHAPTERS: RegionChapterSpec[] = [
  {
    ...
    orderHooks: [
      ...
      { source: 'homeVisit', id: 'homevisit-xiaocha-lake-tea-gallery', note: '临安茶席留闻读取茶席品相与纸路听闻。', readsItemState: true },
      { source: 'homeVisit', id: 'homevisit-xiaocha-paper-route-return', note: '纸路茶席藏客回访读取原席、复单与湖畔茶肆见闻。', readsItemState: true },
    ],
    homeVisitIds: [
  ...
  },
  {
    ...
    orderHooks: [
      ...
      { source: 'homeVisit', id: 'homevisit-tongshan-copper-silver-ledger', note: '铜山客读取东川矿口活动与铜银成品状态，生成乌铜复样单。', readsItemState: true },
    ...
    nextActions: ['补蜡染人物回访与银染互证后日谈', '继续扩展茶马会后续分支到岭南港口回访', '扩展黔滇多入口 smokeBindings'],
    gaps: ['东川矿口回访与铜银材料状态反馈已接入铜山客家访；剩余转向蜡染人物长线回访、岭南港口回访延展和多入口 smokeBindings。'],
  },
  {
    ...
    orderHooks: [
      ...
      { source: 'homeVisit', id: 'homevisit-yeshu-daye-ore-ledger', note: '冶叔读取大冶矿场活动与铜铁熟料/成器状态，生成熟料复样单。', readsItemState: true },
    ...
    homeVisitIds: ['homevisit-yeshu-daye-ore-ledger', 'homevisit-xiong-lacquer-restoration'],
    ...
    nextActions: ['补湘绣楼人物回访与绣样订单差异', '补渡口水运三阶段摊位收束', '让荆楚路线影响赣鄱/徽州材料流动'],
    gaps: ['大冶矿口材料状态反馈已接入冶叔家访；剩余转向湘绣楼人物回访、绣样订单差异、渡口水运三阶段摊位和水路影响外溢。'],
  },
  {
