...
export const REGION_CHAPTERS: RegionChapterSpec[] = [
  ...
  },
  {
    ...
    nextActions: ['补蜡染人物回访与银染互证后日谈', '继续扩展茶马会后续分支到岭南港口回访'],
    gaps: ['东川矿口回访与铜银材料状态反馈已接入铜山客家访；剩余转向蜡染人物长线回访和岭南港口回访延展，M1/F3 多入口 smokeBindings 已覆盖。'],
  },
  {
  ...
  },
  {
    ...
    nextActions: ['补颜料矿谷/银器帐房人物回访与材料状态反馈', '补雪山驿路护商结果接入供展续单后日谈'],
