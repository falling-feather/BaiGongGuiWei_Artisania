...
export const REGION_ACTIVITIES: ActivityDef[] = [
  ...
  act('bs-tea-horse-post', 'bashu', 'bashu-tea-horse', '茶马驿', 'route', 'bs-mabang-ayue', ['route_plan'], '护送、换茶与开路。', '马帮阿越把山路画在桌上，问你货轻还是路稳更要紧。', { resources: { tea: 2 }, attributes: { commerce: 1, stamina: 1 }, flags: ['heard-snow-pass'], routeIds: ['route-bashu-qiandian-tea-horse', 'route-bashu-xueyu-snow-pass'], descriptorTags: ['route', 'trade'] }),
  ...
  act('qd-tea-horse-road', 'qiandian', 'qiandian-tea-road', '茶马驿道', 'route', 'qd-mu-luozi', ['route_plan'], '驮运、换茶与开路。', '木骡子把铃挂到马鞍上，教你听路上的风。', { resources: { teaLeaf: 2 }, attributes: { commerce: 1, stamina: 1 }, flags: ['tea-horse-contact'], routeIds: ['route-bashu-qiandian-tea-horse', 'route-qiandian-jingchu-mine'], descriptorTags: ['route'] }),

  act('jc-ferry-market', 'jingchu', 'jingchu-lake-market', '渡口市集', 'trade', 'jc-qinglu', ['route_plan', 'timing_hold'], '水路运输与鱼获。', '船娘清芦借你一段水路，把芦荡里的风向讲清。', { resources: { coin: 8 }, attributes: { commerce: 1, people: 1 }, routeIds: ['route-bashu-jingchu-river', 'route-qiandian-jingchu-mine', 'route-jingchu-ganpo-lake'], descriptorTags: ['route'] }),
  ...
  act('hz-merchant-hall', 'huizhou', 'huizhou-merchant-hall', '徽商会馆', 'trade', 'hz-cheng-yuanzhou', ['route_plan'], '借贷、押货与远商。', '程远舟翻开账册，先看你的商誉，再谈路费。', { resources: { coin: 10 }, attributes: { commerce: 2 }, flags: ['huizhou-merchant-credit'], routeIds: ['route-jiangnan-huizhou-paper', 'route-ganpo-huizhou-merchant'], descriptorTags: ['trade'] }),
  ...
  act('jj-official-gate', 'jingji', 'jingji-official-gate', '官署门房', 'trade', 'jj-song-yasi', ['dialogue_check'], '采办许可与名声审查。', '宋押司不看你带多少货，先问这货是谁保的名。', { attributes: { people: 1, commerce: 1 }, flags: ['met-palace-clerk'], routeIds: ['route-jiangnan-jingji-canal', 'route-jingji-sanjin-official'], descriptorTags: ['trade'] }),
  ...
  act('sj-piaohao', 'sanjin', 'sanjin-piaohao', '日升票号', 'trade', 'sj-lei-zhanggui', ['route_plan'], '汇兑、借贷与押货。', '雷掌柜写下一张小票，告诉你信用也会磨损。', { resources: { coin: 12 }, attributes: { commerce: 2 }, flags: ['piaohao-credit'], routeIds: ['route-jingji-sanjin-official'], descriptorTags: ['trade'] }),
  ...
  act('xy-snow-pass', 'xueyu', 'xueyu-snow-pass', '雪山驿口', 'route', 'xy-yak-captain', ['route_plan'], '高寒行路与补给。', '牦牛队长把风口标在雪上，提醒你少带虚货。', { resources: { coin: 10 }, attributes: { stamina: 2, commerce: 1 }, flags: ['snow-pass-known'], routeIds: ['route-bashu-xueyu-snow-pass', 'route-xueyu-xiyu-caravan'], descriptorTags: ['route'] }),
  ...
  act('xiyu-bazaar-trade', 'xiyu', 'xiyu-bazaar', '绿洲巴扎', 'trade', 'xu-sali', ['route_plan'], '换货、议价与稀有材料。', '胡商萨里笑着开价，话里三分货，七分路。', { resources: { jadeRough: 1 }, attributes: { commerce: 2, people: 1 }, flags: ['bazaar-contact'], routeIds: ['route-xueyu-xiyu-caravan'], descriptorTags: ['trade'] }, 1, { coin: 8 }),
