...
export const REGION_ACTIVITIES: ActivityDef[] = [
  ...
  act('jn-lake-tea-house', 'jiangnan', 'jiangnan-linan', '湖畔茶肆', 'life', 'jn-su-xiaocha', ['timing_hold', 'dialogue_check'], '烹茶、听闻与社交。', '茶汤起沫时，邻桌商人正谈起徽州纸谷的路价。', { resources: { tea: 1 }, attributes: { people: 1, knowledge: 1 }, flags: ['heard-huizhou-paper-route'], descriptorTags: ['daily'] }, 1, { teaLeaf: 1 }),
