...
export const CRAFTS: Craft[] = [
  {
    ...
    resources: ['plantDye', 'water', 'cloth'],
    ...
    processChain: [
      {
        id: 'harvest-indigo',
        name: '采蓝制靛',
        description: '采收蓝草、沤制成靛泥，是蓝染色彩的源头。',
        resourceCost: { plantDye: 2 },
        laborCost: 2,
    ...
    processChain: [
      {
        id: 'select-bamboo',
        name: '选竹刮青',
        description: '挑选竹龄合适的竹材，刮去青皮。',
        resourceCost: { bamboo: 2 },
        laborCost: 1,
      ...
      },
      {
        id: 'split-strips',
        name: '剖篾分丝',
        description: '将竹材剖成粗细均匀的篾丝，最见功力。',
        resourceCost: { tools: 1 },
        laborCost: 2,
